          ...
          <div className="checkout-summary">
            <div className="summary-box">
              ...
              <div className="coupon-row">
                <input type="text" placeholder="" className="coupon-input" />
                ...
                {summaryLoading ? (
                  ...
                  <>
                    <div className="summary-row">
                      ...
                      <span>₦{orderSummary.subtotal?.toLocaleString() || '0'}</span>
                    </div>
                    <div className="summary-row">
                      <span>Shipping</span>
                      <span>₦{orderSummary.shipping_cost?.toLocaleString() || '0'}</span>
                    </div>
